            ...
            <tbody >
                @forelse($treinamento as $treinamentos)
                    <tr>
                        ...
                        <td><b>{{$treinamentos->OPERADOR}}<b></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body " id="BuscaID">
                    <form name="cadastro" method="post" action="#">
                        ...
                        <button type='button' class="btn btn-secondary btn-sm" id="btCliIdFiltroTreinamento">Busca</button>
                    </form><br>
                    <div id="buscaFiltro">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body " id="BuscaID">
                    <form name="cadastro" method="post" action="#">
                        <b id="cnpj_cpf">CNPJ/CPF:</b><b id="nome_razao">Nome/Razao:</b>
                        <input type='checkbox' id='ativosTR' name='ativosTR' checked>
                        <label for="ativosTR">Ativos</label><br>
