...
<head>
    ...
    <title>Politicas de Privacidade e </title>
...
<body>
    ...
    <div class="container-fluid" style="display: flex; justify-content: center; margin: 1rem 0rem 1rem 0rem;">
        <button id="btTermos" class="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#PoliticasDePrivacidade" aria-expanded="false" aria-controls="collapseExample">
            Politicas de Privacidade
        </button>
        <button id="btTermos" class="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#TermosEuso" aria-expanded="false" aria-controls="collapseExample">
            Termos & Uso
        </button>
    </div>
        <div class="collapse" id="PoliticasDePrivacidade">
            <div class="card card-body">
            <h4>POLÍTICA DE PRIVACIDADE</h4>
            <h5>SEÇÃO 1 - INFORMAÇÕES GERAIS</h5>
            <p> A presente Política de Privacidade contém informações sobre coleta, uso, armazenamento, tratamento e proteção dos dados pessoais dos usuários do CRM-GALAGO , com a finalidade de demonstrar absoluta transparência quanto ao assunto e esclarecer a todos interessados sobre os tipos de dados que são coletados, os motivos da coleta e a forma como os usuários podem gerenciar ou excluir as suas informações pessoais.
                Esta Política de Privacidade aplica-se a todos os usuários do CRM-GALAGO e integra os Termos e Condições Gerais de Uso do CRM-Galago, devidamente inscrita no CNPJ sob o nº 02.887.418/0001-98, situado em Edifício The Union - Bloco B2 Sala 417 Smas Trecho 3, S/N Asa Sul - Brasília DF CEP 71215-300, doravante nominada GALAGO SISTEMA DE AUTOMACAO COMERCIAL LTDA.
            ...
            <h5>SEÇÃO 2 - COMO RECOLHEMOS OS DADOS PESSOAIS DO USUÁRIO?</h5>
            <p> Os dados pessoais do usuário e visitante são recolhidos pela plataforma da seguinte forma:
                Quando o usuário cria uma conta/perfil na plataforma CRM-GALAGO: esses dados são os dados de identificação básicos, como Email e Nome. A partir deles, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidade. Ficam cientes os usuários e visitantes de que seu perfil na plataforma estará acessível a todos demais usuários e visitantes da plataforma CRM-GALAGO.
                Quando um usuário acessa o CRM-GALAGO: as informações sobre interação e acesso são coletadas pela empresa para garantir uma melhor experiência ao usuário e visitante. Estes dados podem tratar sobre as palavras-chaves utilizadas em uma busca, o compartilhamento de um documento específico, comentários, visualizações de páginas, perfis, a URL de onde o usuário e visitante provêm, o navegador que utilizam e seus IPs de acesso, dentre outras que poderão ser armazenadas e retidas.
                Por intermédio de terceiro: a plataforma CRM-GALAGO recebe dados de terceiros, como inforamções do Facebook e Google, quando um usuário faz login com o seu perfil de um desses sites. A utilização desses dados é autorizada previamente pelos usuários junto ao terceiro em questão.
                outras
            </p>
            <h5>SEÇÃO 3 - QUAIS DADOS PESSOAIS RECOLHEMOS SOBRE O USUÁRIO?</h5>
            <p> Os dados pessoais do usuário recolhidos são os seguintes:
                Dados para a criação da conta/perfil na plataforma email e nome.
                Dados para otimização da navegação: não são recolhidos dados para otimização
                Dados para concretizar transações: não coletamos dados para transações
                Newsletter: não há cadastro de visitantes.
                Dados sensíveis: não há coleta de dados sensíveis
                Dados relacionados a contratos: não há celebração de contratos na plataforma.
            </p>
            <h5>SEÇÃO 3 - PARA QUE FINALIDADES UTILIZAMOS OS DADOS PESSOAIS DO USUÁRIO ?</h5>
            <p> Os dados pessoais do usuário coletados e armazenados pela plataforma CRM-GALAGO tem por finalidade:
                ...
                Anúncios: não há anuncios.
                Comercial: os dados não são usados para personalizar o conteúdo oferecido ou gerar subsídio à plataforma para a melhora da qualidade no funcionamento dos serviços.
            ...
            <p> Os dados pessoais do usuário são armazenados pela plataforma durante o período necessário para a prestação do serviço ou o cumprimento das finalidades previstas no presente documento, conforme o disposto no inciso I do artigo 15 da Lei 13.709/18.
            ...
            <p> Os cookies referem-se a arquivos de texto enviados pela plataforma ao computador do usuário e visitante e que nele ficam armazenados, com informações relacionadas à navegação no site. Tais informações são relacionadas aos dados de acesso como local e horário de acesso e são armazenadas pelo navegador do usuário e visitante para que o servidor da plataforma possa lê-las posteriormente a fim de personalizar os serviços da plataforma.
                O usuário da plataforma CRM-GALAGO manifesta conhecer e aceitar que pode ser utilizado um sistema de coleta de dados de navegação mediante à utilização de cookies.
            ...
            <p> Ao utilizar os serviços e fornecer as informações pessoais na plataforma, o usuário está consentindo com a presente Política de Privacidade.
                ...
                O usuário tem direito de retirar o seu consentimento a qualquer tempo, para tanto deve entrar em contato através do e-mail suporte@galago.com.br ou por correio enviado ao seguinte endereço: Edifício The Union - Bloco A Sala 417 Smas Trecho 3, S/N Asa Sul - Brasília DF CEP 71215-300
            ...
            <p> Para a solução de controvérsias decorrentes do presente instrumento será aplicado integralmente o Direito brasileiro.
                Os eventuais litígios deverão ser apresentados no foro da comarca em que se encontra a sede da empresa.
            </p>
            </div>
        </div>
        <div class="collapse" id="TermosEuso">
            <div class="card card-body">
            <h4>Termos e condições gerais de uso do CRM-Galago</h4>
<p>Os serviços do CRM-Galago são fornecidos pela pessoa jurídica com a seguinte Razão Social/nome: GALAGO SISTEMA DE AUTOMACAO COMERCIAL LTDA , com nome fantasia Galago, inscrito no CNPJ/CPF sob o nº 02.887.418/0001-98, titular da propriedade intelectual sobre software, website, aplicativos, conteúdos e demais ativos relacionados à plataforma CRM-Galago.</p>
<h5>1. Do objeto</h5>
...
<p>A plataforma caracteriza-se pela prestação do seguinte serviço: Registro de Atendimento.<p>
<h5>2. Da aceitação</h5>
<p>O presente Termo estabelece obrigações contratadas de livre e espontânea vontade, por tempo indeterminado, entre a plataforma e as pessoas físicas ou jurídicas, usuárias do CRM-Galago.</p>
...
<h5>3. Do acesso dos usuários</h5>
...
<p>O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao CRM-Galago. O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.</p>
...
<h5>5. Dos serviços ou produtos</h5>
<p>Não haverá comercio pela plataforma.</p>
<h5>6. Dos preços</h5>
<p>Não haverá comercio pela plataforma.</p>
<h5>7. Do cancelamento</h5>
<p>Não haverá comercio pela plataforma.</p>
<h5>8. Da troca e devolução</h5>
<p>Não haverá comercio pela plataforma.</p>
<h5>9. Do suporte</h5>
<p>Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do email SUPORTE@GALAGO.COM.BR  OU telefone (61) 3964-9292.</p>
<p>Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários: segunda à sexta de 09:00 às 18hrs.</p>
<h5>10. Das responsabilidades</h5>
...
<h6>É de responsabilidade da plataforma CRM-Galago:</h6>
...
<h5>11. Dos direitos autorais</h5>
...
<p>O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social Galago Sistemas, puníveis nos termos da legislação aplicável.</p>
<h5>12. Das sanções</h5>
<p>Sem prejuízo das demais medidas legais cabíveis, a razão social GALAGO SISTEMA DE AUTOMACAO COMERCIAL LTDA poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:</p>
...
<h5>13. Da rescisão</h5>
<p>A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social GALAGO SISTEMA DE AUTOMACAO COMERCIAL LTDA e o bloqueio de todos os serviços prestados ao usuário.</p>
<h5>14. Das alterações</h5>
<p>Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte da GALAGO SISTEMA, para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas pelo CRM-Galago e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.</p>
<p>Os serviços oferecidos podem, a qualquer tempo e unilateralmente, e sem qualquer aviso prévio, ser deixados de fornecer, alterados em suas características, bem como restringido para o uso ou acesso.
<h5>15. Da política de privacidade</h5>
